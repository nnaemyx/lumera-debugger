...
import { Wallet, LogOut, StickyNote } from "lucide-react";
...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-[#4a3f3f] bg-[#1a0f0f]/90 backdrop-blur-xl shadow-lg">
          ...
          {isConnected ? (
            <>
              <div className="hidden sm:flex items-center gap-2 px-4 py-2 bg-amber-500/10 border-2 border-amber-400/40 rounded-xl backdrop-blur-md shadow-lg">
                ...
                <span className="text-sm font-mono text-amber-300 font-semibold" style={{ fontFamily: 'var(--font-jetbrains-mono)' }}>
