...
import { Wallet, LogOut, FileCode } from "lucide-react";
...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-[#3a3a4e] bg-[#0d0d17]/90 backdrop-blur-xl shadow-lg">
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 bg-gradient-to-br from-cyan-600 via-sky-600 to-blue-600 rounded-2xl flex items-center justify-center shadow-lg glow-primary border-2 border-cyan-400/40">
          ...
          {isConnected ? (
            <>
              <div className="hidden sm:flex items-center gap-2 px-4 py-2 bg-cyan-500/10 border-2 border-cyan-400/40 rounded-xl backdrop-blur-md shadow-lg">
                ...
                <span className="text-sm font-mono text-cyan-300 font-semibold" style={{ fontFamily: 'var(--font-inconsolata)' }}>
